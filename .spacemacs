...
This function should only modify configuration layer settings."
  (setq-default
   ...
   ;; with 线a supported type is opened). Possible values are `all', `unused'
